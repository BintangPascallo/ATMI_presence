...
import 'package:presensi_mahasiswa/riwayat_shift_malam.dart';

// ignore_for_file: must_be_immutable
class ShiftMalam extends StatelessWidget {
  ShiftMalam({Key? key}) : super(key: key);
                    ...
                    children: <Widget>[
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const RiwayatShiftMalam()),
                          );
                        },
                      ),
                    ],
