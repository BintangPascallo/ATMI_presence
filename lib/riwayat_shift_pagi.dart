...
class RiwayatShiftPagi extends StatelessWidget {
  const RiwayatShiftPagi({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      backgroundColor: Colors.white,
        body: SafeArea(
          child: Column(
              children: <Widget>[
              presensiShiftPagi.isEmpty? const Text('Tidak ada absensi',
              textAlign: TextAlign.center,
              style: TextStyle(
              fontSize: 20.0,
              fontFamily: 'Montserrat',
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: presensiShiftPagi.length,
  ...
  Widget getRow(int index) {
    switch(presensiShiftPagi[index].isStatus.toString()){
      case 'Check In':
      ...
      child: Card(
        child: ListTile(
          ...
          title: Column(
            ...
            children: <Widget>[
              Text(presensiShiftPagi[index].isStatus.toString(),
              ...
              Text(presensiShiftPagi[index].date.toString(),
                textAlign: TextAlign.left,
                style: const TextStyle(
                  fontSize: 15.0,
                  fontFamily: 'Montserrat',
              ...
              Text(presensiShiftPagi[index].time.toString(),
                textAlign: TextAlign.left,
                style: const TextStyle(
                  fontSize: 15.0,
                  fontFamily: 'Montserrat',
...
List<PresensiShiftPagi> presensiShiftPagi = List.empty(growable: true);
String imageAssets = '';

void addShiftPagiPresence() {
  ...
  if (globals.isStatus.isNotEmpty && date.isNotEmpty && time.isNotEmpty){
    {
      presensiShiftPagi.add(PresensiShiftPagi(isStatus: globals.isStatus, date: date, time: time));
    }
  }
}
